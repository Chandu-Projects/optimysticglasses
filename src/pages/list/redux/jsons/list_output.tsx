export const list_output = [
  {
    ...
    product_url: 'http://localhost:3000/eyeglassesdetails/id=RX_5279',
    gender: '2', // 2-both
    qty_sold: 100,
    rating: 4.5,
    ...
    created: '20211001',
    modified: '20211101',
    size: 'small', //give numbers 1/2/3 Compromise on storing different sizes as different record
    variants: [
      {
        sku_id: 'SM_BLACK_RX-5279',
        frame_id: 'RX_5279', //use this to update qty_sold above
        color: '#000',
        color_id: '', //optional to increase performance
        src: [
